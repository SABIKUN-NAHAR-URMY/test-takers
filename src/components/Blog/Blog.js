...
const Blog = () => {
    return (
        <div className='w-[70%] text-justify mx-auto'>
            ...
            <div className='border-2 border-slate-400 rounded-lg m-4 p-5'>
                <h1 className='text-3xl font-semibold'><strong>Question-1:</strong> How does context api works?</h1>
                <p>The React Context API is a way for a React app to effectively produce global variables that can be passed around. This is the alternative to "prop drilling" or moving props from grandparent to child to parent, and so on. Context is also touted as an easier, lighter approach to state management using Redux.</p>
            </div>

            <div className='border-2 border-slate-400 rounded-lg m-4 p-5'>
                <h1 className='text-3xl font-semibold'><strong>Question-1:</strong> What is useRef hook in React??</h1>
